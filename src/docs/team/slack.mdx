...
import sections from "../../../static/assets/images/slack_sections.png";
...
If you're familiar with Slack, we do have the features available on the Standard plan.
...
- Adjust your [notification](#notifications) preferences
...
- You can see all channels using the `Channel Browser`.
...
- Create new sections to group your channels:

<img src={sections} style="width: 250px; float: left;" />
