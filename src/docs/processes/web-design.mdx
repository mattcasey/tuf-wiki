...
- [x] &nbsp; Select your website from [My Products](https://account.godaddy.com/products). (You may need to ask TUF admin to create one first!)
...
- [x] &nbsp; Check Google results [send a takedown request](/processes/takedown-requests) to fake landing pages
